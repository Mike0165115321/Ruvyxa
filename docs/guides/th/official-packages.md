...
> 🟡 **ระดับกลาง** · ⏱️ อ่าน ~10 นาที
>
> **จะได้เรียนรู้:** เพิ่มชั้นฐานข้อมูลแบบ typed, ระบบ login/session และ UI อัปเดตสด —
> ทุกแพ็กเกจเป็นทางเลือก ถอดออกได้โดยไม่ต้อง migrate
