...
// One Dark throughout: true color where the terminal advertises it, otherwise the nearest
// xterm-256 slot so the palette still reads the same in a plain 256-color terminal.
...
// One hue per role, straight from One Dark's syntax palette: red directories, blue
// markup, cyan modules, purple styles, chalky config, green assets, foreground-gray docs,
// comment-gray dotfiles and branches. The project root is a directory too, so it reads in
// the same red as the rest of them.
